...
To break on new flaws found from previous scan, add "- dfgdfgdfgfdgdfgdbf results.json" to string and remove "|| true" at the end of the string so the step will break the build process on new flaws.
